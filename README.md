...
Lycia Player 是一个面向本地音乐收藏的桌面播放器，重点放在音乐库整理、播放体验、歌词显示和 Windows 桌面集成上。
...
本项目基于个人兴趣开发，并使用 AI 工具辅助完成。功能会优先围绕作者自己的本地音乐使用场景推进，部分功能测试覆盖仍有限；遇到问题可以通过 Issue 反馈。
...
- 当前主要适配 Windows，macOS 和 Linux 仍需要额外测试。
- 项目仍处于 Alpha 阶段，部分边缘场景可能存在问题。
- 快捷键设置页尚未完成。
